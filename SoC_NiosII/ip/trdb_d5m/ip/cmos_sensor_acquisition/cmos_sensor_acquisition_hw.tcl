...
proc compose {} {
    ...
    add_instance clk_in clock_source 20.1
    ...
    add_instance clk_out clock_source 20.1
    ...
    add_instance cmos_sensor_input_0 cmos_sensor_input 20.1
    ...
    add_instance dc_fifo_0 altera_avalon_dc_fifo 20.1
    ...
    add_instance mm_bridge_0 altera_avalon_mm_bridge 20.1
